        ...
        controller: function ($scope, $uibModalInstance, Setting, $timeout, $http, $sce, $state) {
          ...
          $scope.submit = function (setting) {
            ...
            var newSetting = new Setting({
              ...
              semesterOneStart: setting.semesterOneStart,
              semesterOneEnd: setting.semesterOneEnd,
              semesterTwoStart: setting.semesterTwoStart,
              semesterTwoEnd: setting.semesterTwoEnd
