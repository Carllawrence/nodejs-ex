...
angular.module('starsApp')
  .controller('AttendanceController', function ($rootScope, WizardHandler, $element, $filter, $uibModal, Upload, Payslip, $scope, newApp, $state, $http, AuthService, $timeout, Application, User, filterFilter, $location) {
