...
angular
  ...
  //starts application
  .run(function ($rootScope, $window, $state, AuthService, $http, editableOptions, editableThemes) {
    var settings = [];
...
//This fixes the Internet Explorer caching issue.
  ...
  .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
    ...
    $stateProvider
      ...
      .state('application', {
        ...
        templateUrl: 'views/application/home.html',
        access: { restricted: true, status: 0 },
        resolve: {
          loadMyDirectives: function ($ocLazyLoad) {
            return $ocLazyLoad.load(
              ...
              $ocLazyLoad.load(
                ...
                {
                  name: 'AngularPrint',
                  files: ['bower_components/angularPrint/angularPrint.js',
      ...
      .state('dashboard.attendance', {
        templateUrl: 'views/dashboard/staff/attendance.html',
        ...
        resolve: {
          loadControllers: function ($ocLazyLoad) {
            return $ocLazyLoad.load(
              {
                name: 'starsApp',
                files: ['scripts/controllers/attendance.js'
                ]
              })
          }
        }
      ...
      .state('dashboard.grades', {
        ...
        templateUrl: 'views/pages/academicCalendar.html',
        ...
        resolve: {
          loadControllers: function ($ocLazyLoad) {
            return $ocLazyLoad.load(
              {
                name: 'starsApp',
                files: ['scripts/controllers/calendar.js'
                ]
              })
          }
        }
       ...
       .state('dashboard.eproject', {
        templateUrl: 'views/dashboard/student/eproject.html',
        controller: 'eProjectController',
        url: '/eproject',
        access: { restricted: true, status: 0 },
        resolve: {
          loadControllers: function ($ocLazyLoad) {
            return $ocLazyLoad.load(
              {
                name: 'starsApp',
                files: ['scripts/services/eProjectDataService.js',                
                  'scripts/controllers/eproject.js'
                ]
              })
          }
        }
      ...
      .state('dashboard.eprojectDetail', {
        templateUrl: 'views/dashboard/student/eprojectDetail.html',
        controller: 'eProjectController',
        url: '/eprojectDetail/:eprojectId',
        access: { restricted: true, status: 0 },
        resolve: {
          loadControllers: function ($ocLazyLoad) {
            return $ocLazyLoad.load(
          ...
          loadMyDirectives: function ($ocLazyLoad) {
            return $ocLazyLoad.load(
              ...
              $ocLazyLoad.load(
                {
                  name: 'ui.rCalendar',
                  files: ['bower_components/ng-responsive-calendar/dist/js/calendar-tpls.js',
