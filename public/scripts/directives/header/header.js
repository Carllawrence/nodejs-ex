      ...
      controller: function ($scope, $window, $rootScope) {
        ...
        switch ($rootScope.currentUser.status) {
          ...
          case 2:
            ...
            { "name": "Courses", "url": "dashboard.courses", "icon": "book" },
            { "name": "Grades", "url": "dashboard.myGrades", "icon": "check" },
            { "name": "Learn", "url": "dashboard.learn", "icon": "users" },
            { "name": "Innovate", "url": "dashboard.eproject", "icon": "lightbulb-o" },  
            { "name": "Attendance", "url": "dashboard.attendance", "icon": "check" },                        
          ...
          case 3:
            ...
            { "name": "Events", "url": "dashboard.createEvent", "icon": "calendar" },
               { "name": "Calendar", "url": "dashboard.calendar", "icon": "calendar" },
          ...
          case 4:
            ...
            { "name": "Attendance", "url": "dashboard.attendance", "icon": "sun-o" },            
